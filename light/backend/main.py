...
# Configure uvicorn loggers to ensure they propagate to root
for name in ["uvicorn", "uvicorn.access", "uvicorn.error"]:
    lvl = logging.getLogger(name)
...
async def initialize_on_startup() -> None:
    """Initialize database and seed required defaults at application startup."""
